...
def test_carbon_fee_threshold_logic_full_annual_when_subject():
    ...
    assert above.scenario_fee_standard_ntd == 26000 * 300
    assert above.scenario_fee_preferential_a_ntd == 26000 * 50
    assert above.scenario_fee_preferential_b_ntd == 26000 * 100
